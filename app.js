...
(function () {
    ...
    // VR Data
    const vrData = [
        { name: { ar: 'مطار نجران', en: 'Najran Airport' }, image: 'https://images.unsplash.com/photo-1529074123720-69b000c7959b?w=800&q=80', link: 'https://www.google.com/maps/search/Fairmont+Dubai/@25.2266424,55.2841268,3a,75y,297.67h,79.32t' },
        { name: { ar: 'مصنع سليل للتعبئة', en: 'Salil Packaging Factory' }, image: 'https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=800&q=80', link: 'https://www.google.com/maps/@24.470581,54.3726667,3a,75y,305.37h,82.88t' },
        { name: { ar: 'بالرياض', en: 'In Riyadh' }, image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&q=80', link: 'https://www.google.com/maps/@36.2101965,44.0457465,3a,75y,120.98h,82.56t' }
    ];
